...
## Project Structure
    ...
    ├── goby_on_demand_deli_30530  # Django project configurations
...
1. Clone this repo and `cd goby_on_demand_deli_30530`
...
2. Clone this repo and `cd goby_on_demand_deli_30530`
